...
if($PSVersiontable.PSVersion.Major -lt 3)
{
    ...
    Write-Output "Download from: https://www.python.org/ftp/python/3.10.1/python-3.10.1-embed-amd64.zip"
...
{
    Invoke-WebRequest -Uri https://www.python.org/ftp/python/3.10.1/python-3.10.1-embed-amd64.zip -OutFile python.zip
